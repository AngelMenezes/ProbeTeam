...
namespace ProbeTeam.Infra.DataAccess.Repositories.Teams
{
    public class SQLiteTeamsRepository : EntityFrameworkRepositoryBase<Guid, Team>, ITeamRepository
    {
        public SQLiteTeamsRepository(string devicePlatform)
        {

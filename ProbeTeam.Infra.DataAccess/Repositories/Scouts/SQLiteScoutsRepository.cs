...
namespace ProbeTeam.Infra.DataAccess.Repositories.Scouts
{
    public class SQLiteScoutsRepository : EntityFrameworkRepositoryBase<Guid, Scout>, IScoutRepository
    {
        public SQLiteScoutsRepository(string devicePlatform)
        {

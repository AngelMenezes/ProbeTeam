...
namespace ProbeTeam.Infra.DataAccess.Repositories.Notepads
{
    public class SQLiteNotepadsRepository : EntityFrameworkRepositoryBase<Guid, Notepad>, INotepadRepository
    {
        public SQLiteNotepadsRepository(string devicePlatform)
        {
